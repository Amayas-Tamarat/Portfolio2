    ...
    return (
        ...
        >
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 w-full">
                ...
                <div ref={textRef}>
                    <h2 id="about-heading" className="text-5xl sm:text-6xl font-bold font-playfair mb-6 leading-tight text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">
                        À propos de moi
                    </h2>
                    <p className="text-lg text-gray-300 font-manrope leading-relaxed">
                        Je suis un <strong className="text-purple-400">développeur FullStack</strong> passionné, spécialisé dans la création d'applications web élégantes, performantes et intuitives. J'adore transformer des idées complexes en expériences simples et fonctionnelles.
                    </p>
                    ...
                    <div className="mt-14 w-full flex flex-col items-center space-y-10">
                        <section className="w-full max-w-xl bg-[#1a1a1a] border border-purple-500 rounded-2xl p-6 shadow-lg transition-transform duration-300 hover:scale-[1.02] hover:border-purple-400">
                        ...
                        <div className="flex flex-col sm:flex-row gap-8 w-full max-w-4xl justify-center">
                            <section className="flex-1 bg-[#1a1a1a] border border-green-500 rounded-2xl p-6 shadow-lg transition-transform duration-300 hover:scale-[1.02] hover:border-green-400">
                                <h3 className="text-xl font-bold mb-4 text-green-400">
                                    Développement Backend
                                </h3>
                                <GlassIcons items={backendTech} />
                            </section>
                            <section className="flex-1 bg-[#1a1a1a] border border-blue-500 rounded-2xl p-6 shadow-lg transition-transform duration-300 hover:scale-[1.02] hover:border-blue-400">
